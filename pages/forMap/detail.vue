    ...
    <div class="centerCon">
      <div class="breadcrumbCon">
        <el-breadcrumb separator-class="el-icon-arrow-right">
          ...
          <el-breadcrumb-item class="withCursor" @click.native="toUnderstand">{{ type === 1 ? '明白纸' : '公示栏' }}</el-breadcrumb-item>
          <el-breadcrumb-item>{{ type === 1 ? '明白纸详情' : '公示栏详情' }}</el-breadcrumb-item>
        </el-breadcrumb>
      </div>
