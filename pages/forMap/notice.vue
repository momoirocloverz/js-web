    ...
    <div class="centerCon">
      <div class="breadcrumbCon">
        <el-breadcrumb separator-class="el-icon-arrow-right">
          ...
          <el-breadcrumb-item>注意事项</el-breadcrumb-item>
        </el-breadcrumb>
      </div>
      <div class="contentCon" ref="htmlTarget">
        <div class="title">{{ info.zysx_title }}</div>
        <div class="timeCon">
          <div>
            <span>发布时间：</span>
        ...
        <div class="htmlContent" v-html="info.zysx_content"></div>
      ...
      this.ApiLists.downloadInvestBsydPdf(data)
        .then((res) => {
          if (res) {
            ...
            const fileName = '注意事项' + Date.now() + '.pdf'
