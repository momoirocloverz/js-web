<template>
  <div class="attractDetailPageCon">
    <div class="centerCon">
      <div class="breadcrumbCon">
        <el-breadcrumb separator-class="el-icon-arrow-right">
          ...
          >
          <el-breadcrumb-item class="withCursor" @click.native="toAttract"
            >招商简介项目</el-breadcrumb-item
          >
...
export default {
  ...
  methods: {
    ...
    downloadTrigger() {
      ...
      this.ApiLists.downloadAttractInvestment(data)
        .then(res => {
          if (res) {
            const content = res;
            const blob = new Blob([content]);
            const fileName = "招商简介详情" + Date.now() + ".pdf";
    ...
    initRequest() {
      ...
      this.ApiLists.fetchAttractInvestmentInfo(data)
        .then(res => {
          if (res && res.code == 0) {
            this.info = res.data;
          } else {
