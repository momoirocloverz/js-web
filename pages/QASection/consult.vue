  ...
  <div class="consult">
    <div class="breadcrumbCon">
      <el-breadcrumb separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item @click.native="routerGo('/QASection')">问答专区</el-breadcrumb-item>
      ...
      <div class="form-con">
        <el-form :model="formData" :rules="rules" ref="formData" label-width="100px" class="demo-ruleForm">
          ...
          <el-form-item label="内容" prop="desc">
            <el-input type="textarea" v-model="formData.desc" placeholder="请输入内容，字数不超过200字" maxlength="200"></el-input>
          </el-form-item>
          <el-form-item>
      ...
      submitForm(formName) {
        this.$refs[formName].validate(async (valid) => {
          if (valid) {
            ...
            const result = await this.ApiLists.submitQuestion(this.formData);
            if(result.code === 0) {
