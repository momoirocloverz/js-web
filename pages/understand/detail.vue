<template>
  <div class="understandDetailPageCon">
    <div class="centerCon">
      <div class="breadcrumbCon">
        <el-breadcrumb separator-class="el-icon-arrow-right">
          <el-breadcrumb-item class="withCursor" @click.native="toHome">首页</el-breadcrumb-item>
          <el-breadcrumb-item class="withCursor" @click.native="toUnderstand">{{ type === 1 ? '明白纸' : '公示公告栏' }}</el-breadcrumb-item>
          <el-breadcrumb-item>{{ type === 1 ? '明白纸详情' : '公示公告详情' }}</el-breadcrumb-item>
        </el-breadcrumb>
      </div>
...
export default {
  ...
  methods: {
    ...
    async initRequest() {
      ...
      const result = this.type === 1 ? await this.ApiLists.fetchUnderstandPaperInfo(data) : await this.ApiLists.fetchNoticeDetail(data)
